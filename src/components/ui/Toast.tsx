  ...
  return (
    <AnimatePresence>
      {notificationToast && (
        ...
        >
          <div className="bg-white/95 backdrop-blur-md text-[#172033] rounded-full px-4 py-3 flex items-center gap-3 shadow-xl border border-[#DCE8F7]">
            <span className="text-lg text-[#2563EB]">⚡</span>
            ...
            <button
              ...
              className="text-[#64748B] hover:text-[#172033] p-1 rounded-full transition-colors"
            >
